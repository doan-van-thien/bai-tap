...
try {
    ...
    $nguoigui = 'doanvanthien27112003@gmail.com';
    $matkhau = 'xrcuuoopqerakgaz'; // mật khẩu ứng dụng đã tạo ở bước 3
    $tennguoigui = 'Thien';
    ...
    $to = "thiendv.21it@vku.udn.vn";
    $to_name = "ĐOÀN VĂN THIÊN";
...
$email_array = explode(",",$recipients);*/
    ...
    $mail->AddAttachment("DRAGON.png", "picture");
